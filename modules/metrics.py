...
def display_kpi_metrics(df, df_selection):
	...
	filtered_total_assets_approved = int(df_selection[df_selection["status"] == "Approved"]["slrn"].nunique())
	filtered_total_assets_rejected = int(df_selection[df_selection["status"] == "Rejected"]["slrn"].nunique())
	filtered_total_customers_approved = int(df_selection[df_selection["status"] == "Approved"]["ac_no"].nunique())
	filtered_total_customers_rejected = int(df_selection[df_selection["status"] == "Rejected"]["ac_no"].nunique())
